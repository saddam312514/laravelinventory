$(document).ready( function(){
    ...
    $('#product_purchase_report_form #variation_id, #product_purchase_report_form #location_id, #product_purchase_report_form #supplier_id, #product_purchase_report_form #product_pr_date_filter, #product_purchase_report_form #category_filter').change( function(){
        product_purchase_report.ajax.reload();
    });
    ...
    $('#product_sell_report_form #variation_id, #product_sell_report_form #location_id, #product_sell_report_form #customer_id, #product_sell_report_form #category_filter').change( function(){
        product_sell_report.ajax.reload();
        product_sell_grouped_report.ajax.reload();
    });
