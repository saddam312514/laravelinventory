    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            ...
            $sells = Transaction::leftJoin('contacts', 'transactions.contact_id', '=', 'contacts.id')
                    ->leftjoin('transaction_sell_lines', 'transaction_sell_lines.transaction_id', '=', 'transactions.return_parent_id')
                    ->join(
                    ...
                    ->select(
                        ...
                        DB::raw('SUM(IF(transaction_sell_lines.quantity_returned>0,1,0)) as returned_product')
                    );
